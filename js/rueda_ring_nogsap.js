...
(function(){
  ...
  // In SVG 0deg points to the RIGHT; to bring a segment's center to the TOP,
  // we rotate by -(angle + 90)
  ...
  // Tooltip helpers (no-op if #wheelTip is missing)
  ...
  // Outline hover helpers (optional)
  ...
  // Build white outlines once (if not present)
